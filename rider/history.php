<div class="col">
    <div class="container mt-4">
        ...
        <div class="row">
            <?php
                $sql = $conn->query("SELECT tb_order.*,tb_user.*,tb_shop.shop_name FROM tb_order LEFT JOIN tb_user ON tb_order.cus_name = tb_user.user_id LEFT JOIN tb_shop ON tb_user.user_id = tb_shop.user_id WHERE tb_order.order_status = 3 AND tb_order.r_id='".$_SESSION['user_id']."' ");
                $num = $sql->num_rows;
                if ($num <= 0) {

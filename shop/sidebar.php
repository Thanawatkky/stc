    ...
    <div class="col-auto d-sm-none d-md-flex d-lg-flex collapse" id="navbarSupportedContent">
        ...
        <li class="mb-1">
            <button class="btn btn-toggle align-items-center rounded collapsed fs-6 fw-bold" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
            การจัดการ
            </button>
            <div class="collapse px-3" id="dashboard-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li><a href="index.php?p=addtype_product" class="text-muted link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">เพิ่มหมวดหมู่อาหาร</a></li>
                <li><a href="index.php?p=product" class="text-muted link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">รายการอาหาร</a></li>
            </ul>
            </div>
        </li>
        <li class="mb-1">
            <a href="index.php?p=salesum" class="btn btn-toggle align-items-center rounded collapsed fs-6 fw-bold">
            สรุปยอดขาย
            </a>
        </li>
        ...
        <?php 
    $sql_pf = $conn->query("SELECT tb_user.*,tb_shop.shop_name FROM tb_user LEFT JOIN tb_shop ON tb_user.user_id = tb_shop.user_id WHERE tb_user.user_id='".$_SESSION['user_id']."' ");
        ...
        <div class="row m-0 pb-2">
                ...
                <div class="col-8 text-dark p-0">
                    <div class="text-center">
                        <h6 class="fw-bold"><?= $fet_pf->shop_name; ?></h6>
                    </div>
                    <div class="text-center">
                        <h6>ประเภทผู้ใช้: ร้านอาหาร</h6>
                    </div>
            </div>
        </div>
    </div>
